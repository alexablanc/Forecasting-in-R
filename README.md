...
## 🔍 Output Chart
The chart below compares actual desk sales (2020) to historical averages and projected. Chart originally visualized in Excel as part of an interactive dashboard for scenario testing.
